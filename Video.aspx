<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Video.aspx.cs" Inherits="MySpace.Video" %>
...
<body>
    <form id="form1" runat="server">
       <nav id="navbar">
        ...
        <ul>
          <li><asp:HyperLink class="nav-link" ID="HyperLink2" runat="server" NavigateUrl="~/Dashboard.aspx"><i class="fas fa-cloud"></i>My Drive</asp:HyperLink></li>
          <li>
...
.Card:hover img {
	transform: scale(1.2);
                    ...
                    <div class="Card">
                        <video height = "250" width ="280" controls><source src="video/<%#Eval("video") %>" type="video/mp4"></video>
                        </div>
                </ItemTemplate>
			</asp:DataList>
                </div>
